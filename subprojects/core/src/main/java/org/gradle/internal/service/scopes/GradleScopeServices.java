...
public class GradleScopeServices extends DefaultServiceRegistry {
    ...
    TaskExecutionGraphInternal createTaskExecutionGraph(
        ...
        return new DefaultTaskExecutionGraph(taskPlanExecutor, workInfoExecutors, buildOperationExecutor, workerLeaseService, coordinationService, gradleInternal, taskInfoFactory, dependencyResolver, graphListeners, taskListeners);
    }
